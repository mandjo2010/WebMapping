...
var Overlay = function (_super) {
  ...
  function Overlay(options) {
    ...
    _this.setPositioning(options.positioning !== undefined ? options.positioning : _OverlayPositioning.default.TOP_LEFT);
...
function get(projectionLike) {
  return typeof projectionLike === 'string' ? (0, _projections.get)(projectionLike) :
  /** @type {Projection} */
  projectionLike || null;
}
/**
...
map.on('singleclick', function (evt) {
  if ($('#draggable-title').text() !== "Measure") {
    ...
    var hdms = (0, _coordinate.toStringHDMS)((0, _proj.toLonLat)(coordinate)); // Getting The Layer by its name
...
},{"ol/ol.css":"node_modules/ol/ol.css","ol/Overlay":"node_modules/ol/Overlay.js","ol/coordinate":"node_modules/ol/coordinate.js","ol/proj":"node_modules/ol/proj.js","./customFunctions":"Scripts/customFunctions.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
